  ...
  return (
    <div className="animate-fade-in space-y-5">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 pb-3.5 border-b border-gray-100">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="px-1.5 py-0.5 text-[11px] font-medium bg-gray-100 text-gray-600 rounded-[4px] border border-gray-200/80">
              {teamMembers.length}
            </span>
          </div>
        ...
        <div className="flex items-center gap-2 shrink-0">
          <Button
            icon={<FiRefreshCw size={12} className={loadingMembers ? "animate-spin" : ""} />}
            onClick={() => refetch()}
            size="small"
            className="text-gray-600 hover:text-gray-900 border-gray-200 rounded-[4px] text-xs h-7.5 px-2.5"
          >
            Refresh
          </Button>
          <Button
            ...
            className="bg-gray-900 hover:bg-black text-white font-medium text-xs h-7.5 px-3 rounded-[4px]"
          >
            Add Member
          </Button>
        </div>
      ...
      {loadingMembers ? (
        ...
        <div className="py-12 px-4 rounded-[6px] border border-dashed border-gray-200 bg-gray-50/50 text-center flex flex-col items-center justify-center">
          <div className="w-10 h-10 rounded-[4px] bg-gray-100 text-gray-600 border border-gray-200 flex items-center justify-center mb-2.5">
            <FiUsers size={18} />
          </div>
          <h3 className="text-xs font-semibold text-gray-800">No team members added yet</h3>
          <p className="text-[11.5px] text-gray-400 max-w-sm mt-1 mb-3.5">
          ...
          <Button
            ...
            icon={<FiUserPlus size={13} />}
            onClick={handleOpenAddModal}
            className="bg-gray-900 hover:bg-black text-white text-xs h-7.5 px-3 rounded-[4px]"
          >
            Add First Member
          </Button>
        </div>
        ...
        <>
          {/* Desktop Table View (Clean, No Horizontal Scrollbar) */}
          <div className="hidden sm:block w-full overflow-hidden">
            <table className="w-full text-left text-[12.5px] border-collapse table-auto">
              <thead>
                <tr className="border-b border-gray-100 text-[10.5px] font-semibold uppercase tracking-wider text-gray-400">
                  <th className="pb-2 font-medium">User</th>
                  <th className="pb-2 font-medium">Role</th>
                  <th className="pb-2 font-medium">Module Access</th>
                  <th className="pb-2 font-medium">Store Access</th>
                ...
                {teamMembers.map((member) => {
                  ...
                  return (
                    <tr key={member.id} className="hover:bg-gray-50/60 transition-colors group">
                        ...
                        <div className="flex items-center gap-2">
                          {member.profile_picture ? (
                            <img
                              ...
                              className="w-7 h-7 rounded-[4px] object-cover border border-gray-200/80 shrink-0"
                            />
                          ) : (
                            <div className="w-7 h-7 rounded-[4px] bg-gray-100 text-gray-700 font-semibold flex items-center justify-center text-[10.5px] shrink-0 uppercase border border-gray-200/80">
                              {member.full_name?.slice(0, 2) || member.email?.slice(0, 2)}
                            </div>
                          )}
                          <div className="min-w-0 max-w-[140px] md:max-w-[170px]">
                            <p className="font-semibold text-gray-800 truncate text-[12px] leading-tight">
                      ...
                      {/* Role (Clean Neutral Badge) */}
                      <td className="py-2.5 pr-2">
                        <span className="inline-block text-[11px] font-medium text-gray-700 bg-gray-100 border border-gray-200/80 px-2 py-0.5 rounded-[4px] whitespace-nowrap">
                          {member.role_label}
                        </span>
                      </td>
                      ...
                      <td className="py-2.5 pr-2">
                        <Tooltip
                          ...
                          title={
                            <div className="text-xs space-y-1.5 font-poppins">
                              <div className="flex items-center justify-between border-b border-gray-100 pb-1.5 mb-1.5">
                                <span className="font-semibold text-gray-900 text-[11.5px]">Permitted Modules</span>
                                <span className="text-[10.5px] font-medium text-gray-500 bg-gray-100 px-1.5 py-0.5 rounded-[3px]">
                                  ...
                                  return (
                                    <div
                                      ...
                                      className={`flex items-center gap-2 text-[11px] py-0.5 ${
                                        has ? "text-gray-800" : "text-gray-400 opacity-40 line-through"
                                      }`}
                                    >
                                      <span
                                        className={`w-1.5 h-1.5 rounded-full shrink-0 ${
                                          has ? "bg-gray-900" : "bg-gray-300"
                                        }`}
                                      />
                                      <span>{mod.label}</span>
                                    </div>
                        ...
                        >
                          <span className="inline-block px-2 py-0.5 rounded-[4px] bg-gray-50 text-gray-700 border border-gray-200/80 font-medium text-[11px] cursor-pointer hover:bg-gray-100 hover:text-gray-900 transition-colors whitespace-nowrap">
                            {assignedCount === totalModules
                              ? "All Modules"
                      ...
                      {/* Store Access (Clean Neutral Badge) */}
                      <td className="py-2.5 pr-2">
                        {isAllStores ? (
                          <span className="inline-block text-[11px] text-gray-600 font-medium bg-gray-50 px-2 py-0.5 rounded-[4px] border border-gray-200/70 whitespace-nowrap">
                            All Stores
                          </span>
                        ) : (
                          <Tooltip
                            ...
                            title={
                              <div className="font-poppins text-[11px]">
                                <p className="font-semibold text-gray-900 pb-1 mb-1 border-b border-gray-100 text-[11px]">Assigned Stores</p>
                                <div className="space-y-0.5 text-gray-700">
                                  {member.assigned_accounts?.map((accId) => {
                                    const found = bolAccounts.find((b) => b.account_id === accId);
                                    return (
                                      <p key={accId}>{found ? found.account_name : accId}</p>
                                    );
                                  })}
                                </div>
                              </div>
                          ...
                          >
                            <span className="inline-block text-[11px] text-gray-700 font-medium bg-gray-100 px-2 py-0.5 rounded-[4px] border border-gray-200/80 cursor-pointer hover:bg-gray-200 transition-colors whitespace-nowrap">
                      ...
                      {/* Status */}
                      <td className="py-2.5 pr-2">
                        <span className="inline-flex items-center gap-1.5 text-[11.5px] font-medium text-gray-600 whitespace-nowrap">
                          <span
                            className={`w-1.5 h-1.5 rounded-full shrink-0 ${
                        ...
                        <div className="flex items-center justify-end gap-0.5">
                          ...
                          >
                            <button
                              ...
                              className="p-1 text-gray-400 hover:text-gray-800 hover:bg-gray-100 rounded-[4px] transition-colors"
                            >
                              <FiEdit2 size={13} />
                            </button>
                          </Tooltip>
                          ...
                          >
                            <Tooltip
                              ...
                              title="Delete Member"
                            >
                              <button className="p-1 text-gray-400 hover:text-red-600 hover:bg-red-50 rounded-[4px] transition-colors">
                                <FiTrash2 size={13} />
                              </button>
                            </Tooltip>
                          </Popconfirm>
          ...
          {/* Mobile Card View (Proper Responsiveness for screens < 640px) */}
          <div className="sm:hidden space-y-2.5">
            {teamMembers.map((member) => {
              ...
              return (
                <div
                  key={member.id}
                  className="p-3 bg-white border border-gray-200/80 rounded-[4px] space-y-2.5 shadow-sm"
                >
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <span className="inline-flex items-center gap-1.5 text-[11px] font-medium text-gray-600 shrink-0">
                      <span
                  ...
                  <div className="flex items-center gap-1.5 flex-wrap">
                    <span className="text-[11px] font-medium text-gray-700 bg-gray-100 border border-gray-200/80 px-2 py-0.5 rounded-[4px]">
                      {member.role_label}
                    </span>
                    <span className="text-[11px] font-medium text-gray-700 bg-gray-50 border border-gray-200/80 px-2 py-0.5 rounded-[4px]">
                      {assignedCount === totalModules ? "All Modules" : `${assignedCount}/${totalModules} Modules`}
                    </span>
                    <span className="text-[11px] font-medium text-gray-600 bg-gray-50 border border-gray-200/70 px-2 py-0.5 rounded-[4px]">
                      {isAllStores ? "All Stores" : `${member.assigned_accounts?.length || 0} Stores`}
                    </span>
                  </div>
                  ...
                  <div className="flex items-center justify-end gap-1 pt-2 border-t border-gray-100">
                    <Button
                      ...
                      onClick={() => handleOpenEdit(member)}
                      className="rounded-[4px] text-xs h-7 text-gray-600 hover:text-gray-900"
                    >
                      Edit
                    </Button>
                    <Button
      ...
      <Modal
        title={
          <div className="flex items-center gap-2.5 pb-2 border-b border-gray-100">
            <div className="w-7 h-7 rounded-[4px] bg-gray-100 text-gray-700 border border-gray-200 flex items-center justify-center">
              <FiUserPlus size={14} />
            </div>
            <div>
        ...
        styles={{ content: { borderRadius: "6px" } }}
        destroyOnClose
      >
        <div className="space-y-3.5 pt-2 text-[13px]">
          {/* Full Name & Email */}
          ...
          <div className="p-3 bg-gray-50/70 rounded-[4px] border border-gray-200/80">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              {MODULE_DEFINITIONS.map((mod) => {
                ...
                return (
                  <label
                    key={mod.key}
                    className={`flex items-start gap-2 p-2 rounded-[4px] cursor-pointer transition-colors border ${
                      isChecked
              ...
              <div className="pt-2 border-t border-gray-200/60 mt-2 space-y-1.5">
                {bolAccounts.length === 0 ? (
                  ...
                  bolAccounts.map((acc) => (
                    <label
                      key={acc.account_id}
                      className="flex items-center gap-2 p-1.5 rounded-[4px] hover:bg-white cursor-pointer text-xs"
                    >
                      <Checkbox
          ...
          {/* Password Options */}
          <div className="p-3 bg-gray-50/70 rounded-[4px] border border-gray-200/80 space-y-2">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="text-[11.5px] text-gray-800 hover:underline font-medium"
              >
          ...
          <div className="flex items-center justify-end gap-2 pt-2 border-t border-gray-100">
            <Button className="rounded-[4px]" onClick={() => setAddModalOpen(false)}>Cancel</Button>
            <Button
              type="primary"
              loading={creatingUser}
              onClick={handleCreateMember}
              className="bg-gray-900 hover:bg-black text-white font-medium rounded-[4px]"
            >
      ...
      >
        <div className="space-y-3.5 pt-2 text-[13px]">
          ...
          <div className="flex items-center justify-between p-3 bg-gray-50/70 rounded-[4px] border border-gray-200/80">
            <div>
      ...
      >
        <div className="space-y-3.5 pt-2 text-[13px]">
          ...
          <div className="flex items-center justify-end gap-2 pt-3 border-t border-gray-100">
            <Button className="rounded-[4px]" onClick={() => setResetModalOpen(false)}>Cancel</Button>
            <Button
              type="primary"
              loading={resettingPw}
      ...
      <Modal
        ...
        footer={[
          <Button
            ...
            className="bg-gray-900 hover:bg-black text-white rounded-[4px]"
          >
            Done
          </Button>,
        ]}
      ...
      >
        <div className="space-y-3 pt-2 text-[13px]">
          ...
          <div className="p-3 bg-gray-50 border border-gray-200 rounded-[4px] space-y-2 font-mono text-xs">
            <div className="flex items-center justify-between">
              <span className="text-gray-400 select-none">Login Email:</span>
              <div className="flex items-center gap-2">
                <span className="font-semibold text-gray-800">{createdCredentials?.email}</span>
                <button
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <span className="font-semibold text-gray-900 bg-white border border-gray-200 px-2 py-0.5 rounded-[4px]">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="font-semibold text-gray-800">{createdCredentials?.role}</span>
            </div>
          </div>
          ...
          <Button
            ...
            className="text-xs font-medium rounded-[4px] border-gray-200"
          >
